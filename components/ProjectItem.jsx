...
const ProjectItem = ({title, backgroundImg, technology, projectUrl}) => {
  return (
    <div className='relative flex items-center justify-center h-auto w-full border-2 border-[#40e0d0]  dark:border-gray-600 hover:shadow-xl shadow-[#40e0d0] hover:shadow-[#40e0d0] dark:shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#012033] to-[#0A3B49] hover:scale-[102%] ease-in duration-200'>
